...
MAX_WORKER = 150
DONWLOAD_SUB = True
DOWNLOAD_DEFAULT_LANGUAGE = False # True to select default language, False to select language
SELECTED_LANGUAGE = "English" # Ex. "English" if DOWNLOAD_DEFAULT_LANGUAGE is False
failed_segments = []
    ...
    def download_subtitle(self):
        ...
        if self.subtitle_playlist:
            for sub_info in self.subtitle_playlist:
                ...
                open(os.path.join(path, full_name + ".vtt"), "wb").write(requests.get(url_subititle).content)
